    ...
    <div class="container fixed-top">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav">
                    <li>
                        <a class="nav-link" href='<spring:url value="/logout"></spring:url>'><i class="fas fa-sign-out-alt"></i> Đăng xuất</a>
                    </li>
                </ul>
            </div>
        </nav>
                ...
                <div class="col-sm-9">
                    <table class="table table-striped table-hover">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            ...
                            <ul class="navbar-nav">
                            	<li>
                                	<button type="button" class="btn btn-outline-primary" onclick="location.href='/thihuong/admin/add-chude'">
                                		<i class="fas fa-plus-square"></i> Thêm Câu hỏi
                                	</button>
                            	</li>
                            </ul>
                        </nav>
                        ...
                        <tbody>
                            <c:forEach items="${dsChuDe}" var="chuDe">
                            	<tr>
	                            	...
	                            	<td>${chuDe.chuDe}</td>
	                            	<td>
	                                    <button type="button" title="Sửa" onclick="editChuDe('${chuDe.maChuDe}')" class="btn btn-outline-info">
	                                    	<i class="fas fa-edit"></i>
	                                    </button>
	                                    <button type="button" title="Xóa" onclick="deleteChuDe('${chuDe.maChuDe}');" class="btn btn-outline-danger">
