            ...
            <div class="row">
                ...
                <div class="col-sm-9">
                    <table class="table table-striped table-hover">
                        ...
                        <nav class="navbar navbar-expand-lg">
                            <ul class="navbar-nav mr-auto">
                                <form class="form-inline my-2 my-lg-0">
                                    <input class="form-control mr-sm-2" type="search" placeholder="Tìm kiếm thí sinh" aria-label="Search">
                        ...
                        <tbody>
                            <c:forEach items="${dsThiSinh}" var="thiSinh">
	                            <tr>
	                            	<th scope="row">1</th>
	                            	<td>${thiSinh.maThiSinh}</td>
	                                <td>${thiSinh.hoTen}</td>
	                                <td>${thiSinh.taiKhoan.email}</td>
	                                <td>${thiSinh.SDT}</td>
	                                <td>
